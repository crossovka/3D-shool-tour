...
function eventKrpanoLoaded (isWebVr) {
	...
	ktools.I18N.getInstance().initLanguage(tourLanguage, crossDomainTargetUrl+'2 tourdata/2 tour_messages_','.xml');
	krpanoLoaded = true;
...
function eventTourChangeLanguage (pLang) {
	...
	ktools.I18N.getInstance().initLanguage(pLang, crossDomainTargetUrl+'2 tourdata/2 tour_messages_','.xml');
}
...
function addKolorFloorPlan(pPlugID, pContent)
{
	...
	{
		var kolorFloorPlanCSS = new ktools.CssStyle("KolorFloorPlanCSS", crossDomainTargetUrl+"2 tourdata/graphics/KolorFloorPlan/kolorFloorPlan.css");
		var kolorFloorPlanJS = new ktools.Script("KolorFloorPlanJS", crossDomainTargetUrl+"2 tourdata/graphics/KolorFloorPlan/KolorFloorPlan.min.js", [], true);
...
function showKolorFloorPlan(pPlugID, pContent)
{
	...
	if(!kolorFloorPlan.isReady())
	{
		...
		//set url for images
		kolorFloorPlan.setGraphicsUrl(crossDomainTargetUrl+"2 tourdata/graphics/"+pPlugID.toLowerCase()+"/");
...
function addKolorArea(pPlugID)
{
	if(typeof ktools.KolorPluginList.getInstance().getPlugin(pPlugID) == "undefined")
	{
		var kolorAreaCSS = new ktools.CssStyle("KolorAreaCSS", crossDomainTargetUrl+"2 tourdata/graphics/KolorArea/kolorArea.css");
		var kolorAreaJS = new ktools.Script("KolorAreaJS", crossDomainTargetUrl+"2 tourdata/graphics/KolorArea/KolorArea.min.js", [], true);
